...
# wheels (no source compile — the whole reason for using linux), then run Dima's VFNet inference.
set -e
...
echo "[docker] running VFNet inference ..."
python scripts/vfnet_infer.py
echo "[docker] DONE"
